...
A list of practical projects that anyone can solve in any PHP and JAVA These projects are divided in multiple categories, and each category has it's own folder.

**[Original project link](https://github.com/thekarangoel/Projects)**
...
* I will use PHP and JAVA to solve these.
...
* Will not be solving these problems in any particular order.
